                ...
                case SignInStatus.Success:
                    using (var client = new HttpClient())
                    {
                        var form = new Dictionary<string, string>
                       {
                        ...
                        string apiAddress = Request.Url.AbsoluteUri.Replace(strPathAndQuery, "/token");

                        //HTTP POST
                        var tokenResponse = client.PostAsync(apiAddress, new FormUrlEncodedContent(form)).Result;
